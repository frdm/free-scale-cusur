...
#define PWM_STEER_DC_STRAIGHT_PERIOD_VAL	        (0x0898)//2200
#define PWM_STEER_DC_MAX_RIGHT_PERIOD_VAL		    (0x0992)//2450
#define PWM_STEER_DC_MAX_LEFT_PERIOD_VAL		    (0x076C)//1900
