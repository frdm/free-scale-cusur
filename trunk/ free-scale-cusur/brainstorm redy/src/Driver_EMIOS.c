...
void beMIOS_initEMIOS0_ch0(void)
{
...
//  EMIOS_0.CH[23].CBDR.R = 0x003C;      /* Register B is set at 0x003C */                           	
	/* Set eMIOS0 Channel 23 prescaler (clock division is equal to the UCPRE value + 1) */
	EMIOS_0.CH[0].CCR.B.UCPRE = 0b11;	/* Clock prescaler of 4 for this channel */
	/* Enable clock prescaler for this channel */
	EMIOS_0.CH[0].CCR.B.UCPEN = 1;
	/* Select Internal Counter */
	EMIOS_0.CH[0].CCR.B.BSL = 0x0; 
	/* Select Channel mode */
	EMIOS_0.CH[0].CCR.B.MODE = 0b1011000;	/*Output Pulse Width and Frequency Modulation Buffered (OPWFMB) mode */
