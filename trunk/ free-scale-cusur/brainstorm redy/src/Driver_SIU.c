...
void vfnInit_Emios0_Output_Pad1(uint8_t u8PcrVal)
{
	SIU.PCR[u8PcrVal].R = 0x0600;//0x0A00;    
			/* Assign PCR_EMIOS_0_channel as an output emios pad */
	 	/* Assign PCR_EMIOS_1_channel as an output emios pad */
}
