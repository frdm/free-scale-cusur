...
/* Bolero micro.                                                              */
/*============================================================================*/
#ifndef MALbeMIOS_H                                 /* To avoid double inclusion */
#define MALbeMIOS_H
...
extern void MALbeMIOS_initEMIOS0(void);
extern void MALbeMIOS_initEMIOS0_ch23(void);
extern void MALbeMIOS0_setPWMBdutyCycle(T_UBYTE lub_channel, E_PWM_DC_CHM le_changeMode, T_UWORD luw_steps);
extern void MALbeMIOS0_PITinit(void);
extern void MALbeMIOS0_PITch0_init(void);
